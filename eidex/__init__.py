...
def log_work(message: str, extra_info: dict = None) -> None:
    ...
    """
    from .database import log_work as _log_work
...
def fetch_branch_logs(branch: str = None, limit: int = None) -> list:
    ...
    """
    from .database import fetch_branch_logs as _fetch_branch_logs
...
def cleanup_deleted_branches() -> int:
    ...
    """
    from .database import cleanup_deleted_branches as _cleanup_deleted_branches
...
def prune_old_logs(days: int) -> int:
    ...
    Returns:
        Number of deleted log entries
    """
    from .database import prune_old_logs as _prune_old_logs
...
def create_default_config() -> str:
    ...
    """
    from .file_generators import create_default_config as _create_default_config
...
def create_ai_context_file() -> str:
    ...
    """
    from .file_generators import create_ai_context_file as _create_ai_context_file
...
def ensure_db() -> str:
    ...
    """
    from .database import ensure_db as _ensure_db
    return _ensure_db()
...
def get_repo_root() -> str:
    ...
    """
    from .config import get_repo_root as _get_repo_root
...
def get_current_branch() -> str:
    ...
    Raises:
        ValueError: If not in a Git repository
    """
    from .database import get_current_branch as _get_current_branch
